...
use Zotel\Wallet\Test\Infra\Factories\ItemMultiPriceFactory;
use Zotel\Wallet\Test\Infra\Factories\UserCashierFactory;
...
use Zotel\Wallet\Test\Infra\Models\ItemMultiPrice;
...
final class MultiWalletTest extends TestCase
{
    ...
    public function testTransfer(): void
    {
        ...
        self::assertSame(WalletTransfer::STATUS_TRANSFER, $transfer->status);
    ...
    public function testUserCashier(): void
    {
        ...
        self::assertSame($transaction->type, WalletTransaction::TYPE_DEPOSIT);
