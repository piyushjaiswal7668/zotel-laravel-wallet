...
use Zotel\Wallet\Test\Infra\Listeners\BalanceUpdatedThrowDateListener;
use Zotel\Wallet\Test\Infra\Listeners\BalanceUpdatedThrowIdListener;
use Zotel\Wallet\Test\Infra\Listeners\BalanceUpdatedThrowUuidListener;
use Zotel\Wallet\Test\Infra\Listeners\TransactionCreatedThrowListener;
use Zotel\Wallet\Test\Infra\Listeners\WalletCreatedThrowListener;
...
final class EventTest extends TestCase
{
    ...
    public function testTransactionCreatedThrowListener(): void
    {
        ...
        $message = hash('sha256', WalletTransaction::TYPE_DEPOSIT.$createdAt);
